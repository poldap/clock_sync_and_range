...
3. [Cramer-Rao_lower_bounds_and_Monte-Carlo_experiments.ipynb](https://nbviewer.jupyter.org/github/poldap/clock_sync_and_range/blob/master/Cramer-Rao_lower_bounds_and_Monte-Carlo_experiments.ipynb): 
